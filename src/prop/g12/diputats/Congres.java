...
public class Congres {
	...
	private Integer[][] afinitats;
	
	public Congres() {this.congres = new ArrayList<Diputat>();}
	
	public ArrayList<Diputat> getCongres() {return congres;};
	
	public void setCongres(ArrayList<Diputat> congres) {this.congres = congres;}
	
	public Integer[][] getAfinitats() {return afinitats;}
	
	public void setAfinitats(Integer[][] afinitats) {this.afinitats = afinitats;}
	...
	public void initAfi() {
		Integer n = congres.size();
		afinitats = new Integer[n][n];
		for(int i = 0; i < n; i++) {
			for(int j = 0; j < n; j++) {
				afinitats[i][j] = 0;
			}
	...
	private void afinitatEmpresa(int i, int j, int a) {
	...
	private void afinitatIdeologia(int i, int j, int a) {
		Diputat d1 = congres.get(i);
		Diputat d2 = congres.get(j);
	...
	private void afinitatProcedencia(int i, int j, int a) {
		Diputat d1 = congres.get(i);
		Diputat d2 = congres.get(j);
	...
	private void afinitatEsdeveniment(int i, int j, int a) {
		Diputat d1 = congres.get(i);
		Diputat d2 = congres.get(j);
